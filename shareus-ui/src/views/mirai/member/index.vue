<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
            v-hasPermi="['mirai:member:remove']"
            :disabled="multiple"
            icon="Delete"
            plain
            type="danger"
      ...
      <el-col :span="1.5">
        <el-button
            v-hasPermi="['mirai:member:export']"
            icon="Download"
            plain
            type="warning"
            @click="handleExport"
    ...
    <el-table v-loading="loading" :data="memberList" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center" class-name="small-padding fixed-width" label="操作">
        <template #default="scope">
          <el-button v-hasPermi="['mirai:member:edit']" icon="Edit" link type="primary"
                     @click="handleUpdate(scope.row)">修改
          </el-button>
          <el-button v-hasPermi="['mirai:member:remove']" icon="Delete" link type="primary"
