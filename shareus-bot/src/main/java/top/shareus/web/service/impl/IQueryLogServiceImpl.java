...
import top.shareus.web.mapper.IQueryLogMapper;
...
public class IQueryLogServiceImpl extends ServiceImpl<IQueryLogMapper, QueryLog> implements IQueryLogService {
    @Autowired
    private IQueryLogMapper queryLogMapper;
