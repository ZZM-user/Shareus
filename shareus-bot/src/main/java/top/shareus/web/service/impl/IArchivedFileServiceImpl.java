...
import top.shareus.web.mapper.IArchivedFileMapper;
 ...
 */
@Service
public class IArchivedFileServiceImpl extends ServiceImpl<IArchivedFileMapper, ArchivedFile> implements IArchivedFileService {
    @Autowired
    private IArchivedFileMapper IArchivedFileMapper;
    ...
    public ArchivedFile selectArchivedFileById(String id) {
        return IArchivedFileMapper.selectArchivedFileById(id);
    }
    ...
    public List<ArchivedFile> selectArchivedFileList(ArchivedFile archivedFile) {
        return IArchivedFileMapper.selectArchivedFileList(archivedFile);
    }
    ...
    public int insertArchivedFile(ArchivedFile archivedFile) {
        return IArchivedFileMapper.insertArchivedFile(archivedFile);
    }
    ...
    public int updateArchivedFile(ArchivedFile archivedFile) {
        return IArchivedFileMapper.updateArchivedFile(archivedFile);
    }
    ...
    public int deleteArchivedFileByIds(String[] ids) {
        return IArchivedFileMapper.deleteArchivedFileByIds(ids);
    }
    ...
    public int deleteArchivedFileById(String id) {
        return IArchivedFileMapper.deleteArchivedFileById(id);
    }
